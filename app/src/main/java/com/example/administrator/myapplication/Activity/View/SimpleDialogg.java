...
public class SimpleDialogg extends Dialog {
    ...
    public SimpleDialogg(Context context, int style) {
    ...
    public SimpleDialogg setClickListener(View.OnClickListener listener) {
        this.listener = listener;
        bt_confirm.setOnClickListener(listener);
        return this;
    }

    public SimpleDialogg setMessage(String message) {
        dialog_message.setText(message);
        return this;
    }

    public SimpleDialogg setTitle(String title) {
        dialog_title.setText(title);
        return this;
    }

    public SimpleDialogg setIcon(int iconResId) {
